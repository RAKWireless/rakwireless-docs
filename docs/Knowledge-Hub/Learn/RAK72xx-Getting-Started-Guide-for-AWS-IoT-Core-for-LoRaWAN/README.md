...
rak_desc: A guide on how to set up the AWS IoT Core of the WisGate Edge RAK72XX Gateway. 
tags:
  - Tutorial
  - WisGate
header: 
  title: RAK72xx Getting Started Guide for AWS IoT Core for LoRaWAN
  caption: by <b>RAKwireless Team</b>
  img: /assets/images/knowledge-hub/banners/general_banner.jpg
posted: 3/29/2021 09:30 PM
---

# RAK72xx Getting Started Guide for AWS IoT Core for LoRaWAN

<b> Table of Contents </b>

1. [Overview](/Knowledge-Hub/Learn/RAK72xx-Getting-Started-Guide-for-AWS-IoT-Core-for-LoRaWAN/#overview)
2. [Definition of Terms](#definition-of-terms)
3. [Hardware](#hardware) 
4. [Set up your AWS Account and Permissions](#set-up-your-aws-account-and-permissions)
5. [Set up the Gateway](#set-up-the-gateway)
6. [Add End Devices](#add-end-devices)
7. [Verifying Operation](#verifying-operation-a-hello-world-example)
...
WisGate Edge is the RAK flagship line of commercial-grade gateways. Gateways from this product line are designed to work either indoor or outdoor, customizable in terms of the backhaul connectivity options, antenna type, and power provisioning. This product group contains three products: [WisGate Edge Prime (RAK7240)](/Product-Categories/WisGate/RAK7240/Overview/), [WisGate Edge Max (RAK7249)](/Product-Categories/WisGate/RAK7249/Overview/), and [WisGate Edge Lite (RAK7258)](/Product-Categories/WisGate/RAK7258/Overview/).
Both the Prime and Max versions are outdoor gateways with solid aluminum enclosures. The Lite version is indoor and has a plastic enclosure. They are all supporting 8 LoRa channels, but the Prime and Max versions have optional support for 16 LoRa channels. 

:::tip 📝 NOTE:

A minimum firmware version of 1.2.0065_Release_r209 is required for all WisGate Edge Gateways to meet the minimum required version of the Semtech Basics Station (2.0.5) for AWS IoT Core for LoRaWAN.
...
The following table shows the Standard Kit Contents of the WisGate products.

<table style="text-align: center">
<thead>
  <tr>
    <th colspan = 3> <b>STANDARD KIT CONTENTS</b></th>
  </tr>
</thead>
<tbody>
        <tr>
            <td><b>WisGate Edge Prime</b><br> (8ch, No Cellular)</td>
            <td><b>WisGate Edge Max</b><br> (8ch, No Cellular)</td>
            <td><b>WisGate Edge Lite</b><br> (No Cellular)</td>
        </tr>
        <tr>
            <td>1x RAK7249 WisGate Edge Prime Gateway <br> 1x Regional Specific LoRa Antenna <br> 1x GPS Antenna <br> 1x 2.4&nbsp;GHz Wi-Fi Antenna <br> 1x PoE Injector <br> 1x Mounting Kit <br> 1x Manual</td>
            <td>1x RAK7249 WisGate Edge Max Gateway <br> 1x Regional Specific LoRa Antenna <br> 1x GPS Antenna <br> 1x 2.4&nbsp;GHz Wi-Fi Antenna <br> 1x PoE Injector <br> 1x Mounting Kit <br> 1x Manual</td>
            <td>1x RAK7249 WisGate Edge Lite Gateway <br> 1x Regional Specific LoRa Antenna <br> 1x Power Adapter <br> 1x Mounting Kit <br> 1x Manual </td>
        </tr>
        <tr>
            <td colspan = 3> <b>For Additional Configuration Options</b> </td>
        </tr>
        <tr>
            <td><a href="https://store.rakwireless.com/collections/wisgate-edge/products/rak7240-outdoor-lpwan-gateway?variant=36068284465310"><b>VISIT STORE</b></a></td>
            <td><a href="https://store.rakwireless.com/collections/wisgate-edge/products/rak7249-diy-outdoor-gateway?variant=26611827933284"><b>VISIT STORE</b></a></td>
            <td><a href="https://store.rakwireless.com/collections/wisgate-edge/products/rak7258-micro-gateway?variant=27155353174116"><b>VISIT STORE</b></a></td>
        </tr>
</tbody>
</table>

:::tip 📝 NOTE:
- **Cat5 Ethernet Cable** for powering with the POE adapter WisGate Edge and Prime gateways is an optional Ethernet cable for LAN connectivity for all WisGate Edge series.
- For datasheets of the WisGate Edge Prime, Max, and Lite, refer to the [WisGate Documentation](/Product-Categories/WisGate/).
- For more details on options and bundles check the [store page](https://store.rakwireless.com/).
- For more detailed information and other configuration options, check the [DocHub](https://docs.rakwireless.com/).
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/8.user-interface.png"
  width="100%"
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/9.firmware-version.png"
  width="100%"
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/figure3.png"
  width="100%"
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/figure4.png"
  width="100%"
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/figure5.png"
  width="100%"
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/13.verifying
.png"
  width="100%"
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/14.add-device-profile
.png"
  width="70%"
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/15.add-service-profile.png"
  width="70%"
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/16.add-destination.png"
  width="70%"
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/17.wireless-device-specification.png"
  width="80%"
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/18.wireless-device-profile.png"
  width="80%"
  caption="Choosing a Wireless Device Profile"
/>

<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/19.choose-destination.png"
  width="80%"
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/20.checking-device.png"
  width="80%"
  caption="Choosing a Destination"
/>
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/21.architecture.png"
  width="100%"
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/22.publish.png"
  width="90%"
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/23.cmd.png"
  width="80%"
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/24.system-log.png"
  width="100%"
  caption="System Log"
/>
...
<rk-img
  src="/assets/images/knowledge-hub/tutorials/aws-iot-core-for-lorawan/reset_button.svg"
  width="60%"
