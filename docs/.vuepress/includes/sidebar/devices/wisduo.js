module.exports = {
  ...
  {
    title: 'LoRaWAN P2P',
    path: '/Product-Categories/WisDuo/RAK811-Module/LoRaWAN-P2P/',
    collapsable: false,
    nested: true,
    download: true,
    sidebarDepth: 4,
    children: [
      ['/Product-Categories/WisDuo/RAK811-Module/LoRaWAN-P2P/Quickstart/', 'Getting Started'],
      ['/Product-Categories/WisDuo/RAK811-Module/LoRaWAN-P2P/AT-Command-Manual/', 'AT Command Manual']
    ]
  },
  {
    title: 'Deep Development',
    path: '/Product-Categories/WisDuo/RAK811-Module/Deep-Development/',
    collapsable: false,
    nested: true,
    download: true,
    sidebarDepth: 4
