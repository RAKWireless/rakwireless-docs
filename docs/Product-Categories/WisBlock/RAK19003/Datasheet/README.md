---
rak_desc: Covers the comprehensive information of your RAK19003 to help you in using it. This information includes technical specifications, characteristics, and requirements, and it also discusses the device components.
...
|       10       |       IO4       |       IO6       |   I/O    |   General purpose IO pin. When 3V3_S is used, this pin cannot be used as interrupt input.   |
|       11       |      3V3_S      |      3V3_S      |    S     | 3.3&nbsp;V power supply. This power pin is controlled by IO2 from the WisBlock Core module. |
|       12       |       IO3       |       IO5       |   I/O    |   General purpose IO pin. When 3V3_S is used, this pin cannot be used as interrupt input.   |
