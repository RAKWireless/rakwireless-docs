---
rak_desc: Contains instructions and tutorials in installing and deploying your RAK5811. Instructions are written in a detailed and step-by-step manner for an easier experience in setting up your device. Aside from the hardware configuration, it also contains a software setup that includes detailed example codes that will help you get started.
tags:
  - quickstart
  - wisblock
  - RAK5811
...
The RAK5811 module is part of the WisBlock Interface category, which connects to the baseboard through the IO slot. The installation method is shown in the Figures below.
...
1. First, you need to select the WisBlock Core you have, as shown in **Figure 9** and **Figure 10**.
...
2. You can access the programming guide for the RAK5811 module by opening the example codes depending on your WisBlock Core, as shown in **Figure 11** and **Figure 12**. 
...
3. After opening the example code, you can now select the right port and upload the code as shown in **Figure 13** and **Figure 14**.
...
4. When you successfully uploaded the example sketch, open the Serial Monitor of the Arduino IDE to see the ADC reading logs as shown in **Figure 15** and **Figure 16**.
