...
There are three ways that you can check the logs for debugging purposes on your RAK5010 WisTrio NB-IoT Tracker Pro:
...
<rk-img
  ...
  width="40%"
  caption="DFU Upgrading of RAK5010 Firmware via BLE"
/>
