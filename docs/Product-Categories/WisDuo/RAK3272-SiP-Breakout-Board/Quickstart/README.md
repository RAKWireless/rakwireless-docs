...
:::tip 📝 NOTE:
Refer to the P2P Mode section of the [AT command documentation](/Product-Categories/WisDuo/RAK3272-SiP-Breakout-Board/AT-Command-Manual/) to learn more about the definition of the parameters used and the individual commands if you want specific parameter changed.
:::

<rk-img
  src="/assets/images/wisduo/rak3272-sip-breakout-board/quickstart/p2p-3.png"
  width="90%"
  caption="Configuring P2P in both RAK3272-SiP Module"
/>
...
<rk-img
  src="/assets/images/wisduo/rak3272-sip-breakout-board/quickstart/p2p-4.png"
  width="90%"
  caption="Configuring P2P in both RAK3272-SiP Module"
/>
