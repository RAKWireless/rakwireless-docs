...
The RAK4270 Breakout Board is shown in Figure 1 that displays the top view of the module.

<rk-img
  src="/assets/images/wisduo/rak4270-breakout-board/datasheet/1.rak4270-breakout-top.png"
  width="15%"
  caption="RAK4270 Breakout Board Illustration"
/>
...
There are two (2) UART interfaces on RAK4270 Breakout Board:

- **UART1** – used as a command or upgrade port and is recommended for debugging and flashing
- **UART2** – used as a command port and is recommended for an external MCU


##### I2C Port

Listed below are the two (2) pins intended for I2C:

- **I2C_SCL**
- **I2C_SDA**

:::tip 📝 NOTE:
Depending on the external device connected to it, it might be necessary to add 10kOhm pullup resistors these lines.
:::
...
| 6 | ANT_SW | I/O | PA11 | This pin has been connected to the internal RF switch so leave it unconnected on mainboard. | 
