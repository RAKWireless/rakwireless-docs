...
This command is used to restore all the parameters to the initial default values of the module.
...
Check [Appendix II Section](/Product-Categories/WisDuo/RAK3272S-Breakout-Board/AT-Command-Manual/#appendix-ii：tx-power-by-region) **TXPower** for the input parameter depending on the frequency band selected.
...
This section describes the output from UART lines of RAK3272S  that can occur at any point in time while the device is operational.
