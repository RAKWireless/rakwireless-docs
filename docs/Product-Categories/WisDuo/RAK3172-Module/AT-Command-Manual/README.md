...
This command allows the user to access and configure the network identifier.

| Command                        | Input Parameter   | Return Value                         | Return Code           |
| ------------------------------ | ----------------- | ------------------------------------ | --------------------- |
| AT+NWKID?                      | -                 | `AT+NWKID: get or set the network ID`  | `OK`                    |
| AT+NWKID=?                     | -                 | *< 1 hex >*                          | `OK`                    |
| AT+NWKID=`<Input Parameter>`   | *< 1 hex >*       | -                                    | `OK` or `AT_PARAM_ERROR`|
...
| AT+DR=`<Input Parameter>`     | 0 or 1            | -                                    | OK *or* AT_PARAM_ERROR|
...
| Command                        | Input Parameter   | Return Value                               | Return Code              |
| ------------------------------ | ----------------- | ------------------------------------------ | ------------------------ |
| AT+TXP?                      | -                 | `AT+RX2FQ: get or set the Rx2 window frequency`| `OK`                      |
...
| Command                        | Input Parameter   | Return Value                               | Return Code              |
| ------------------------------ | ----------------- | ------------------------------------------ | ------------------------ |
| AT+BAND?                      | -                 | `AT+RX2DR: get or set the Rx2 window data rate (0-7) corresponding to DR_X`| `OK`                      |
...
| AT+USEND=`<Input Parameter>`| **port** : **ack** : **nbtrials** : **length** : **payload**             | -                                    | `OK` , `AT_PARAM_ERROR` , `AT_BUSY_ERROR` or `AT_NO_NETWORK_JOINED`|
...
| AT+RSSI=`<Input Parameter>`    | -                 | *< integer > in dBm*                              | `OK` |
...
| AT+SNR=`<Input Parameter>`    | -                 | *< integer >*                            | `OK` |
...
| AT+P2P=?                      | -                 | *`<Freq>,<SF>,<Bandwidth>,<Preamble>,<Power>`*           | `OK` or `AT_ERROR`     |
| AT+P2P=`<Input Parameter>`    | *`<Freq>,<SF>,<Bandwidth>,<Preamble>,<Power>`*      | -                      | `OK` or `AT_PARAM_ERROR`       |
...
| ------------------------------- | ----------------- | ------------------------------------------- | ----------------------------- |
| AT+PSEND?                       | -                 | `AT+PSEND: P2P send data`| `OK`                          |
| AT+PSEND=?                       | -                 | *<`Time in mSec`>* | `OK`                          |
| AT+PSEND=`<Input Parameter>`    | *<`Time in mSec`>*      | -                      | `OK` or `AT_PARAM_ERROR`       |
...
| AT+ADDMULC=`<Input Parameter>`    | *`[Class]:[DevAddr]:[Nw kSKey]:[AppSKey]:[Fr equency]:[Datarate]:[P eriodicity]`*  | -      | `OK` or `AT_PARAM_ERROR`       |
