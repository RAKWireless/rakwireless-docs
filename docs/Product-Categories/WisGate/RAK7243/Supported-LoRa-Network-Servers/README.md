---
rak_desc: Contains a comprehensive guide in setting up your RAK7243 with TTN and ChirpStack.
...
# RAK7243 Supported LoRa Network Servers
...
2. First, you should have connected your gateway to the internet through the router according to the method which has been introduced in the [Accessing the Internet](/Product-Categories/WisGate/RAK7243/Quickstart/#accessing-the-internet) section.

3. Secondly, configure your gateway and choose TTN as the LoRa Server. Then select the correct frequency according to the method which has been introduced in the [Configuring the Gateway](/Product-Categories/WisGate/RAK7243/Quickstart/#configuring-the-gateway) section.

4. Click **Start building** and choose the cluster that is geographically closest to your region.


<rk-img
  src="/assets/images/wisgate/rak7243/supported-lora-network-servers/ttn/1.choose-cluster.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7243/supported-lora-network-servers/ttn/2.console-page.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7243/supported-lora-network-servers/ttn/3.add-gateway.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7243/supported-lora-network-servers/ttn/4.register-gateway.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7243/supported-lora-network-servers/ttn/5.gateway-connected.png"
  width="100%"
...
- However, if it is not the first time you use the gateway and you want to use the built-in ChirpStack as the LoRa Server, follow the steps discussed in the [Configuring the Gateway](/Product-Categories/WisGate/RAK7243/Quickstart/#configuring-the-gateway) section.
...
<rk-img
  src="/assets/images/wisgate/rak7243/supported-lora-network-servers/chirpstack/6.chirpstack-ui.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7243/supported-lora-network-servers/chirpstack/7.available-gateway.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7243/supported-lora-network-servers/chirpstack/8.seen-status.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7243/supported-lora-network-servers/chirpstack/9.login-page.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7243/supported-lora-network-servers/chirpstack/10.registered-gateways.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7243/supported-lora-network-servers/chirpstack/11.fill-in.png"
  width="100%"
  caption="Filling in the details"
/>

- Fill in the gateway ID you got from the [Configuring the Gateway](/Product-Categories/WisGate/RAK7243/Quickstart/#configuring-the-gateway) section, also called gateway EUI.
...
<rk-img
  src="/assets/images/wisgate/rak7243/supported-lora-network-servers/chirpstack/12.successful-registration.png"
  width="100%"
