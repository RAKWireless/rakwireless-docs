---
rak_desc: Contains a comprehensive guide in setting up both your RAK7240 V2 and Amazon Web Services account and permissions. It also includes instructions on connecting and configuring your LoRaWAN Gateway to The Things Network and LORIOT.
...
3. On the Create Role page, choose **AWS account** and select **Next**.
5. In the search box, type **_AWSIoTWirelessGatewayCertManager_**.
...
8. In the confirmation message, choose **View Role** to edit the new role.
9. In the **Summary**, choose the **Trust relationships** tab, and then choose **Edit trust policy**.
...
11.  Choose **Update Policy** to save your changes and exit.
...
4. In the **Gateway details**, fill in the **GatewayEUI** and **Frequency band (RF Region)** fields.
...
3. Check each of the profiles to determine if one of them will work for you.
4. If not, select **Add device profile** and set up the parameters as needed. For US 915 as an example, the values are:
      - MacVersion 1.0.3
...
6. In the **Service Profiles** section, click **Add service profile** and set up the parameters as needed. As an example, the default service profile parameters are shown below. However, only the **_AddGwMetadata_** setting can be changed at this time.
      - UlRate 60
      - UlBucketSize 4096
      - DlRate 60
      - DlBucketSize 4096
...
8. In the **Profiles** section, from the drop-down option, find the Device and Service profile you have created or the one that corresponds to your device and region.
...
- [**Set up the Gateway Hardware**](/Product-Categories/WisGate/RAK7240-V2/Quickstart/#power-on-the-gateway)

- [**Set up the Gateway Software**](/Product-Categories/WisGate/RAK7240-V2/Quickstart/#access-the-gateway)

### Configure the Gateway Device

1. Using your preferred Web browser, access the gateway. To access the gateway, see the Quickstart guide.

<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/1.png"
  width="100%"
  caption="Web User Interface Log-in"
/>

<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/2.png"
  width="100%"
...
3. Navigate to **LoRa**.
4. For **Work mode**, select **Basics station**.
5. Click **Configure Basics Station server setup** to expand the Basics Station settings.

<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/3.png"
  width="100%"
  caption="Basics Station Work Mode"
/>

6. Select **LNS Server** from Server, then choose **TLS Server and Client Authentication** from Authentication Mode.

<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/4.png"
  width="100%"
  caption="Configuring Network Mode to Basics Station"
/>

7. Configure URI, Port, and Authentication Mode.

<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/5.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/6.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/8.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/9.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/10.png"
  width="80%"
  caption="LoRaWAN Specifications and Wireless Device Configuration"
/>

<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/11.png"
  width="80%"
  caption="Choosing a Wireless Device Profile"
/>

<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/12.png"
  width="80%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/13.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/14.png"
  width="100%"
...
7. Under **Code source**, paste the below code into the editor under the **_lambda_function.py_** tab.
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/15.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/16.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/17.png"
  width="100%"
  caption="System Log"
/>
...
1. Unable to see the web login:
    - Check that your wifi is connected to **RAK7240V2_XXXX**.
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/18.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/19.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/21.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/22.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/23.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/24.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/25.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/26.png"
  width="60%"
...
1. To configure the gateway, access it via the Web UI. To learn how to do that, refer to the [Quickstart Guide](https://docs.rakwireless.com/Product-Categories/WisGate/RAK7240-V2/Quickstart/#access-the-gateway).
2. Navigate to **LoRa** > **Configuration** > **Work mode**, and select **Basics station**.

<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/27.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/28.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/29.png"
  width="100%"
...
You can now see that the gateway is connected to TTNv3 as Basics Station.


<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/30.png"
  width="100%"
...
This guide will show you how to connect the RAKWireless Commercial V2 gateway running WisGateOS 2 to a ChirpStack Network server, whether it is installed in the local or external network. It is not about how to install the ChirpStack, but how to configure the gateway to send data to it.

### Configuring the Edge Gateway V2 to ChirpStack

As mentioned before, the guide is for all RAK Edge V2 Series gateways running WisGateOS 2. It is separated into two main sections based on where the ChirpStack Network server is installed:
...
Each option is explained as a separate section.

##### Connecting the Gateway via Packet Forwarder

In this method, you will configure the gateway’s packet forwarder to send data to the ChirpStack Gateway Bridge.

1. Start by accessing the gateway. To see how to access the gateway, refer to the [**Access the Gateway**](https://docs.rakwireless.com/Product-Categories/WisGate/RAK7240-V2/Quickstart/#access-the-gateway) section.


<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/31.png"
  width="100%"
  caption="Successful connection"
/>


2. Login using the set credentials you have set in the  [**Access the Gateway**](https://docs.rakwireless.com/Product-Categories/WisGate/RAK7240-V2/Quickstart/#access-the-gateway) section.
3. On the left side, head to **LoRa**. By default, the gateway is configured to work as a Built-in network server.

<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/32.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/33.png"
  width="100%"
  caption="Setting Packet Forwarder Mode"
/>

5. By default, when the Packet Forwarder mode is chosen, the **Semtech UDP GWMP Protocol** is selected.
6. To point the gateway to the ChirpStack network using the packet forwarder, you need to set the **Server address** of the ChirpStack.
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/34.png"
  width="70%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/35.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/36.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/37.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/38.png"
  width="100%"
...
- **Network-server** - the network server to which the gateway will connect. When no network servers are available from the dropdown, make sure a service profile exists for this organization.
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/39.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/40.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/41.png"
  width="100%"
...
1. Start by accessing the gateway. To access the gateway check the **[Access the Gateway](https://docs.rakwireless.com/Product-Categories/WisGate/RAK7240-V2/Quickstart/#access-the-gateway)** section.

<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/42.png"
  width="100%"
  caption="Login page"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/43.png"
  width="100%"
  caption="Network server settings"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/44.png"
  width="100%"
  caption="Setting Packet Forwarder Mode"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/47.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/48.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/49.png"
  width="70%"
  caption="Configuring Packet Forwarder to ChirpStack"
/>

11.  Click **Save changes** to save the changes.
12.  Now you need to register the gateway in the ChirpStack Network server. When Packet Forwarder mode is chosen, the **Semtech UDP GWMP Protocol** is selected by default. To register the gateway in ChirpStack, see **Registering the Gateway in ChirpStack Network Server** section.
13.  If everything is set correctly, the **Last seen** status will state **a few seconds ago**.

<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/50.png"
  width="100%"
  caption="Registered gateway"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/51.png"
  width="100%"
  caption="Gateway details"
/>

Your gateway is now connected to the ChirpStack Network server.
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/52.png"
  width="100%"
  caption="Login page"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/53.png"
  width="100%"
  caption="Network Server Settings"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/54.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/55.png"
  width="100%"
...
Your gateway is now configured to work as Basics Station, and it is pointed to the ChirpStack gateway bridge. The default installation of the ChirpStack setups the backend configuration of the ChirpStack gateway bridge to `semtech_udp`.
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/57.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/58.png"
  width="100%"
...
10. Then, you need to register the gateway in the ChirpStack Network server. To register the gateway in ChirpStack, see **Registering the Gateway in ChirpStack Network Server** section.
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/59.png"
  width="100%"
  caption="Registered gateway"
/>

<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/60.png"
  width="100%"
  caption="Gateway details"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/61.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/62.png"
  width="100%"
  caption="Login page"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/63.png"
  width="100%"
  caption="Network server settings"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/64.png"
  width="100%"
...
To point the gateway to the ChirpStack network using the packet forwarder, you only need to set the Packet Forwarder mode. The **Semtech UDP GWMP Protocol** is selected by default of the ChirpStack.
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/65.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/66.png"
  width="100%"
  caption="ChirpStack login page"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/67.png"
  width="100%"
  caption="ChirpStack dashboard"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/68.png"
  width="100%"
  caption="Gateway list"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/69.png"
  width="100%"
  caption="Register the gateway"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/70.png"
  width="100%"
  caption="Registered gateway"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/71.png"
  width="100%"
  caption="Gateway details"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/72.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/73.png"
  width="100%"
  caption="Login page"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/74.png"
  width="100%"
  caption="Network server settings"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/75.png"
  width="100%"
  caption="Setting packet forwarder mode"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/78.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/79.png"
  width="100%"
  caption="MQTT for ChirpStack protocol"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/80.png"
  width="100%"
  caption="Configuring packet forwarder to ChirpStack"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/81.png"
  width="100%"
  caption="Registered gateway"
/>

<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/82.png"
  width="100%"
  caption="Gateway details"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/83.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/84.png"
  width="100%"
  caption="Login page"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/85.png"
  width="100%"
  caption="Network server settings"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/86.png"
  width="100%"
  caption="Setting Basics Station mode"
/>
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/87.png"
  width="100%"
  caption="Configuring Basics Station to ChirpStack"
/>
...
Your gateway is now configured to work as Basics Station and it is pointed to the ChirpStack gateway bridge. The default installation of the ChirpStack setups backend of the ChirpStack gateway bridge as `semtech_udp`.
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/90.png"
  width="100%"
...
<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/91.png"
  width="100%"
  caption="Registered gateway"
/>

<rk-img
  src="/assets/images/wisgate/rak7240-v2/supported-lora-network-servers/92.png"
  width="100%"
  caption="Gateway details"
/>
