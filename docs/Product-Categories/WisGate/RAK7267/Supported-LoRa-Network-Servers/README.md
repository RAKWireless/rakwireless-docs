...
1. Using your preferred Web browser, access the gateway. To access the gateway, see the [Quick Start guide](../Quickstart/).
...
1. Start by accessing the gateway. To see how to access the gateway, refer to the [Quick Start guide](../Quickstart/) section.
...
2. Login using the set credentials you have set in the [Quick Start guide](../Quickstart/) section.
...
1. Start by accessing the gateway. To access the gateway check the [Quick Start guide](../Quickstart/).
...
2. Login using the set credentials you have set in the [Quick Start guide](../Quickstart/).
3. On the left side, head to **LoRa**. By default, the gateway is configured to work as a **Built-in network server**.
