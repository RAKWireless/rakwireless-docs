---
rak_desc: Contains a comprehensive guide in setting up your RAK7268 with the supported LoRa network server. It includes instructions in connecting and configuring your LoRaWAN Gateway to LORIOT. 
tags:
  - AWS
  - TTN
  - wisgate
