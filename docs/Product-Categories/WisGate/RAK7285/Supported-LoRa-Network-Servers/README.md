...
<!-- <rk-img
  src="/assets/images/wisgate/rak7285/supported-lora-network-servers/chirpstack/17.payload-marshaler.png"
  width="80%"
...
<!-- <rk-img
  src="/assets/images/wisgate/rak7285/supported-lora-network-servers/chirpstack/48.payload-masher.png"
  width="90%"
